...
## Overview
All changes to `/home/beengud/raibid-labs/term-test/src/pty.rs` are **backward compatible**. No breaking changes were made to existing APIs.
...
The TuiTestHarness in `/home/beengud/raibid-labs/term-test/src/harness.rs` continues to work without any modifications.
